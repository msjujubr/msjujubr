...
CEFET-MGでコンピュータ工学を専攻している学部生です。
コンピューティングと、それをバイオインフォマティクス、創薬、Scientific Computing、サイバーセキュリティ、制御、ロボティクス、Virtual Reality、Augmented Realityなど、さまざまな分野へ応用することに興味があります。

- 📌 [ポートフォリオ - 学術・設計の歩み](https://msjujubr.github.io/portfolio/)
- 🏢 CEFET 第5キャンパス
- 🤖 PETグループ（メカトロニクス工学）
